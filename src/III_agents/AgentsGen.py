...
if __name__ == "__main__":
    # Initialize the AgentsGen wrapper
    agents_gen = AgentsGen(default_model="gpt-4o")
    ...
    async def run_cognitive_swarm_demo():
        ...
        test_query = """
        What might be the societal implications of widespread adoption of AI-powered personal assistants 
        in everyday life over the next decade? Consider both positive and negative aspects.
        """
        ...
        for key, value in memory.items():
            print(f"\n- {key}:")
            print(f"{value[:200]}..." if len(str(value)) > 200 else value)
