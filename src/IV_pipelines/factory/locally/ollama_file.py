...
def save_response_as_code(response):
    ...
    path_to_code = "src/IV_pipelines/ollama_help/code.py"
...
if __name__ == "__main__":
    ...
    ollama_code_code = get_code("src/IV_pipelines/ollama_help/ollama_code.py")
    ...
    while True:
        ...
        prompt = f"""Can you give me an idea or the snippet of how I can create a true file search based on the name when I tag a file name as @file_name:code.py, to actually search for it in the repo than for me having to import it. Here's the full code context: {ollama_code_code}"""
